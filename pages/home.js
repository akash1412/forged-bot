...
const SecTwoStepsImg = styled.div`
	...
	background-size:contain;
	background-repeat:no-repeat;
	background-image:${props => props.step1 ? 'url("/workStep1.png")' :props.step2 ? 'url("/workStep2.png")':'url("/workStep3.png")' };
`;
		...
		<Container>
			<SecOne>
				...
				<SecOnLeft>
					...
					<SecOnePara>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sit sit facilisis porttitor vitae proin.</SecOnePara>
					<SecOneUploadButton><SaveIcon></SaveIcon>Upload Document</SecOneUploadButton>
					<SecOneNote>Your files will be discarded after analysing<br/>.jpg, .jpeg, .png, .pdf formats are supported.</SecOneNote>
				</SecOnLeft>
				<SecOneRight>
					<SecOneImg></SecOneImg>
				</SecOneRight>
			...
			<SecTwo>
				...
				<SecTwoNote>or you can alos tag our twitter bot @forged_bot  to any tweeted photo to check it.</SecTwoNote>
				<SecTwoImg></SecTwoImg>
			</SecTwo>
			<SecThree>
			...
			<Footer>Made with ❤️  by Team Xiken.tech.</Footer>
		</Container>
	);
}
...
const WorkStep = (props) => {
    ...
    return(
        <SecTwoStepsContainer>
            ...
            {num==="1"?<SecTwoStepsImg step1 />:num==="2"?<SecTwoStepsImg step2 />:<SecTwoStepsImg step3 />}
        </SecTwoStepsContainer>
    )
}
